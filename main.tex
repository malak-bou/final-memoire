...
&
\includegraphics[width=\linewidth]{render.png} % <-- adapte ici le nom réel de ton fichier
\end{tabular}
...
Pour l’administration et la visualisation des données, nous avons utilisé pgAdmin 4, un outil graphique qui facilite la gestion des tables, l’exécution de requêtes SQL, et le suivi global de la base de données.
&
\includegraphics[width=\linewidth]{railway.png} % <-- adapte ici le nom réel de ton fichier
\end{tabular}
...
&
\includegraphics[width=\linewidth]{Swagger-logo.png} % <-- adapte ici le nom réel de ton fichier
\end{tabular}
